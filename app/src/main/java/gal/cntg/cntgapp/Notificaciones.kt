...
object Notificaciones {
    ...
    fun lanzarNotificacion (context: Context):Unit
    {
        ...
        var nb = NotificationCompat.Builder(context, ID_CANAL)
            ...
            .setSmallIcon(R.drawable.baseline_density_medium_24)
        ...
        //if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) --> Este if sólo sería necesario si fuera una versión inferior a la 8,
        // pero nuestro build parte justo de la 8.
        //{
